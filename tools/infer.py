...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--weights', type=str, default='./weight.pt', help='model path(s) for inference.')
    parser.add_argument('--source', type=str, default='./images/test', help='the source path, e.g. image-file/dir.')
    parser.add_argument('--yaml', type=str, default='./data/dataset_all_center.yaml', help='data yaml file.')
    ...
    parser.add_argument('--save-img', type=bool, default=True, help='save visuallized inference results.')
    ...
    parser.add_argument('--name', default='test', help='save inference results to project/name.')
