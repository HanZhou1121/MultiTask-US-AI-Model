...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--data-path', default='./data/dataset_all_center.yaml', type=str, help='path of dataset')
    parser.add_argument('--conf-file', default='./yolov6s.py', type=str, help='experiments description file')
    ...
    parser.add_argument('--device', default='5', type=str, help='cuda device, i.e. 0 or 0,1,2,3 or cpu')
    ...
    parser.add_argument('--name', default='positive_negative', type=str, help='experiment name, saved to output_dir/name')
