...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--data', type=str, default='./data/dataset_all_center_negative.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', type=str, default='./runs/train/positive_negative/weights/epoch_185_cancer_83_ulcer_53_negative_0.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--save_dir', type=str, default='./runs/train/positive_negative/eval/', help='evaluation save dir')
