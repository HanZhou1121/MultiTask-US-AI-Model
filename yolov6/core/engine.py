...
class Trainer:
    ...
    def eval_model(self):
        results, cancer, ulcer, negativ = eval.run(self.data_dict,
        ...
        save_checkpoint(ckpt, False, save_ckpt_dir, model_name='epoch_{}_cancer_{}_ulcer_{}_negative_{}'.format(self.epoch, int(cancer*100), int(ulcer*100), int(negativ*100)))
        del ckpt
