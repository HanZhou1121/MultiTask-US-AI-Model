...
class ComputeLoss:
    ...
    def __call__(
        ...
        total_losses = self.reg_weight * loss_iou + loss_l1 + loss_obj + loss_cls * self.cls_weight
        return total_losses, torch.cat((self.reg_weight * loss_iou, loss_l1, loss_obj, loss_cls* self.cls_weight)).detach()
